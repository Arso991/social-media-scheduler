...
const PlatformPickerModal = ({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-900/40 backdrop-blur h-full">
              ...
              <button
                ...
                className={`flex items-center gap-3 p-3.5 rounded-xl border text-left transition-all ${
                  isConnected
                    ...
                    : "border-slate-200 bg-slate-50 hover:border-slate-300 hover:bg-slate-100 cursor-default"
                }
